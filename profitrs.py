...
profits = (20000, 45000, 78000, 97000, 12000, 4560000, 65000, 54000, 1, 30000, 70000, 90000)
...
btn_max = Button(root, text = "Show Max Profitable Month", command = max_, bg = "blue", fg = "white")
btn_max.place(relx = 0.5, rely = 0.4, anchor = CENTER)

btn_min = Button(root, text = "Show Min Profitable Month", command = min_, bg = "blue", fg = "white")
